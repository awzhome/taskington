...
namespace Taskington.Base.TinyBus
{
    ...
    public static class RequestMessageExtensions
    {
        ...
        public static IEnumerable<R> RequestMany<T1, R>(this RequestMessage<T1, IEnumerable<R>> message, T1 param1) =>
           message.Request(param1).SelectMany(r => r);

        public static IEnumerable<R> RequestMany<T1, T2, R>(this RequestMessage<T1, T2, IEnumerable<R>> message, T1 param1, T2 param2) =>
           message.Request(param1, param2).SelectMany(r => r);

        public static IEnumerable<R> RequestMany<T1, T2, T3, R>(this RequestMessage<T1, T2, T3, IEnumerable<R>> message, T1 param1, T2 param2, T3 param3) =>
           message.Request(param1, param2, param3).SelectMany(r => r);

        public static IEnumerable<R> RequestMany<T1, T2, T3, T4, R>(this RequestMessage<T1, T2, T3, T4, IEnumerable<R>> message, T1 param1, T2 param2, T3 param3, T4 param4) =>
           message.Request(param1, param2, param3, param4).SelectMany(r => r);

        public static IEnumerable<R> RequestMany<T1, T2, T3, T4, T5, R>(this RequestMessage<T1, T2, T3, T4, T5, IEnumerable<R>> message, T1 param1, T2 param2, T3 param3, T4 param4, T5 param5) =>
